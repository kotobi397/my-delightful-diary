-- حذف الدوال الموجودة
DROP FUNCTION IF EXISTS public.get_approved_books();
DROP FUNCTION IF EXISTS public.get_all_books();

-- إعادة إنشاء دالة get_approved_books مع slug
...
-- إعادة إنشاء دالة get_all_books مع slug
