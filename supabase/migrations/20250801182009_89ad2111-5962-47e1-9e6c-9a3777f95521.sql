-- حذف الدوال الموجودة وإعادة إنشائها
DROP FUNCTION IF EXISTS public.verify_author(UUID, TEXT);
DROP FUNCTION IF EXISTS public.unverify_author(UUID);
DROP FUNCTION IF EXISTS public.is_author_verified(UUID);
DROP FUNCTION IF EXISTS public.is_author_verified_by_name(TEXT);
