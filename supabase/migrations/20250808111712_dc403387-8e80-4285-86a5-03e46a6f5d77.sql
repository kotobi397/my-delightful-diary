-- Create missing helpers after previous partial migration

-- 1) Update current user's last_seen (idempotent)
...
-- 2) Keep conversations.last_message_at up to date when new messages arrive
