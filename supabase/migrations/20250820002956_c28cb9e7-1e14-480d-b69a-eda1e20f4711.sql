-- إصلاح الترحيل السابق بحذف الـ triggers أولاً
-- التعامل مع حالة الحسابات الإدارية التي ترفع كتب لمؤلفين مختلفين
...
-- ثم حذف الدوال
DROP FUNCTION IF EXISTS sync_author_bio_from_profiles() CASCADE;
DROP FUNCTION IF EXISTS migrate_author_bio_to_profiles() CASCADE;
...
-- تحديث دالة get_book_details لتستخدم التعريف الذكي
